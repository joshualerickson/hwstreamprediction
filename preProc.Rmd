...
data34 %>% count(spatial_cluster80) %>% map_dbl(mean)

data34 %>% count(spatial_cluster80) %>% map_dbl(median)

data34 %>% count(spatial_cluster80) %>% map_dbl(sd)


data34 %>% count(spatial_cluster40) %>% map_dbl(mean)

data34 %>% count(spatial_cluster40) %>% map_dbl(median)

data34 %>% count(spatial_cluster40) %>% map_dbl(sd)
```
