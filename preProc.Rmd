...
data34 %>% add_count(spatial_cluster40, name = "n_40") %>% add_count(spatial_cluster80, name = "n_80") %>% summarise(across(starts_with("n_"), list(mean = mean, median = median, standard_deviation = sd))) %>% t()
